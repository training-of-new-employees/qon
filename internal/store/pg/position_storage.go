...
func (p *positionStorage) CreatePositionDB(ctx context.Context, position model.PositionEdit) (*model.Position, error) {
...
func (p *positionStorage) UpdatePositionDB(ctx context.Context, id int, val model.PositionEdit) (*model.Position, error) {
	position := model.Position{}
