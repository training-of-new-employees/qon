...
type RepositoryPosition interface {
	CreatePositionDB(ctx context.Context, position model.PositionEdit) (*model.Position, error)
	...
	UpdatePositionDB(ctx context.Context, id int, position model.PositionEdit) (*model.Position, error)
