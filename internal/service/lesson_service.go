...
type ServiceLesson interface {
	...
	GetLesson(ctx context.Context, lessonID int, companyID int) (*model.Lesson, error)
	...
	GetLessonsList(ctx context.Context, courseID int, companyID int) ([]model.Lesson, error)
