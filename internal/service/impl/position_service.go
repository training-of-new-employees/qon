...
func (p *positionService) CreatePosition(ctx context.Context, val model.PositionEdit) (*model.Position, error) {
...
func (p *positionService) UpdatePosition(ctx context.Context, id int, val model.PositionEdit) (*model.Position, error) {
