...
type ServiceCourse interface {
	...
	GetUserCourse(ctx context.Context, courseID, userID int) (*model.Course, error)
	...
	GetCompanyCourse(ctx context.Context, courseID, companyID int) (*model.Course, error)
