...
func (s *RestServer) InitRoutes() {
	...
	userEmployeeGroup := userGroup.Group("")
	userEmployeeGroup.Use(s.IsEmployee())
	userEmployeeGroup.GET("/courses", s.handlerGetUserCourses)
	userEmployeeGroup.GET("/courses/:id", s.handlerGetUserCourse)
	userEmployeeGroup.GET("/courses/:id/lessons", s.handlerGetUserCourseLessons)
	userEmployeeGroup.GET("/lessons/:id", s.handlerGetLesson)
	userEmployeeGroup.PATCH("/lessons/:id", s.handlerUpdateLessonStatus)

	userAdminGroup := userGroup.Group("")
	userAdminGroup.Use(s.IsAdmin())
