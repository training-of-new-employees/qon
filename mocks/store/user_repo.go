...
func (mr *MockRepositoryUserMockRecorder) CreateAdmin(ctx, admin, companyName interface{}) *gomock.Call {
...
func (mr *MockRepositoryUserMockRecorder) CreateUser(ctx, user interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryUserMockRecorder) EditAdmin(ctx, edit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryUserMockRecorder) GetUserByEmail(ctx, email interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
