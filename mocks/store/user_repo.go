...
func (m *MockRepositoryUser) CreateAdmin(arg0 context.Context, arg1 model.AdminCreate, arg2 string) (*model.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryUserMockRecorder) GetCompany(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
