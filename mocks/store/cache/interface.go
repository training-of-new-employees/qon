...
func (mr *MockCacheMockRecorder) DeleteRefreshToken(ctx, hashedRefresh interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) GetRefreshToken(ctx, hashedRefresh interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) Set(ctx, uuid, admin interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) SetRefreshToken(ctx, hashedRefresh, originalRefresh interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
