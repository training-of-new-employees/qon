...
func (mr *MockRepositoryCourseMockRecorder) CompanyCourses(ctx, companyID interface{}) *gomock.Call {
...
func (mr *MockRepositoryCourseMockRecorder) CreateCourse(ctx, course interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryCourseMockRecorder) EditCourse(ctx, course, companyID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryCourseMockRecorder) UserCourses(ctx, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
