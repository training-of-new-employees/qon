...
func (mr *MockJWTGeneratorMockRecorder) GenerateToken(id, isAdmin, orgID, hashedRefreshToken, exp interface{}) *gomock.Call {
...
func (mr *MockJWTValidatorMockRecorder) ValidateToken(tokenStr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
