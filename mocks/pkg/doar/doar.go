...
func (mr *MockEmailSenderMockRecorder) InviteUser(email, invitationLink interface{}) *gomock.Call {
...
func (mr *MockEmailSenderMockRecorder) SendCode(email, code interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEmailSenderMockRecorder) SendPassword(email, password interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMailerMockRecorder) SendEmail(email, title, body interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
