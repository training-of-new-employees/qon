...
func (mr *MockServicePositionMockRecorder) AssignCourses(ctx, positionID, courseIDs, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServicePositionMockRecorder) GetPositionCourses(ctx, companyID, positionID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
