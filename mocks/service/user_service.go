...
func (mr *MockServiceUserMockRecorder) ClearSession(ctx, hashedRefreshToken interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceUserMockRecorder) GetInvitationLinkUser(ctx, email, companyID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceUserMockRecorder) RegenerationInvitationLinkUser(ctx, email, companyID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
