...
func (mr *MockServiceCourseMockRecorder) CreateCourse(ctx, c interface{}) *gomock.Call {
...
func (mr *MockServiceCourseMockRecorder) EditCourse(ctx, c, companyID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceCourseMockRecorder) GetCompanyCourses(ctx, companyID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceCourseMockRecorder) GetUserCourses(ctx, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
